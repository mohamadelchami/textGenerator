...
def generateEmail(user, i, outputPath):
    ...
    f = open(outputPath+f"/email{i}.html", 'w')
    f.write(html)
    f.close()
...
def generateText(user, i, outputPath):
    ...
    f = open(outputPath+f"/message{i}.txt", 'w')
    f.write(msg)
    f.close()
...
def main(inputPath, outputPath):
    ...
    while True:
        try:
            ...
            generateEmail(users[i], i, outputPath)
            generateText(users[i], i, outputPath)
